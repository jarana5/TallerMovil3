...
public class RegistroActivity extends AppCompatActivity {
    ...
    private DatabaseReference mRef; //firabase realtime
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                accessCamera = requestPermission(RegistroActivity.this, Manifest.permission.CAMERA, "Permission to Access Camera", CAMERA);
                if(accessCamera){
                    usePermissionCamera();
                }
            }
        ...
        btnGallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                accessAlm = requestPermission(RegistroActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE, "Permission to Access Photo Gallery", ALMACENAMIENTO_EXTERNO);
                if(accessAlm){
                    usePermissionImage();
                }
            }
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(RegistroActivity.this, "Registration failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
